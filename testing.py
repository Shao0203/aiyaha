...
class TwoLayerNet:
    def __init__(self, input_size, hidden_size, output_size, weight_std_init=0.01):
        self.params = {}
        self.params['W1'] = weight_std_init * np.random.randn(input_size, hidden_size)
        self.params['b1'] = np.zeros(hidden_size)
        self.params['W2'] = weight_std_init * np.random.randn(hidden_size, output_size)
    ...
    def load_model(self, filepath):
        ...
        print(f'Model is loaded to {filepath}.')
        self.layers['Affine1'] = Affine(self.params['W1'], self.params['b1'])
        self.layers['Affine2'] = Affine(self.params['W2'], self.params['b2'])


# 6. Mnist dataset training
...
# 7. Plot the loss value and training results
...
ax2.plot(x_acc, test_acc_list, label='test acc', ls=':')
